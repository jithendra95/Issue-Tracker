...
$sql2=" SELECT DISTINCT 
        (select name from bitnami_redmine.projects where id=A.project_id) PROJECT,
        (SELECT COUNT(*) from bitnami_redmine.issues B WHERE B.project_id=A.project_id AND  created_on >= '2016-08-01' AND created_on < '2016-09-01') 
        from bitnami_redmine.issues A 
        WHERE created_on >= '2016-08-01'
        AND   created_on < '2016-09-01'
        ORDER BY PROJECT ";
