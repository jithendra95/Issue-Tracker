...
//alert(start_date);
m_url="PHP/Dashboard_graph.php?chksql='project'&start_date="+start_date+"&end_date="+end_date;
window.open(m_url);
/*$.ajax({
...
<div class="row">
  <div class="col-sm-4"><b>Start Date * </b><input type='text' class='input_field' value='' name='start_date' id='start_date'  ></div>
  <div class="col-sm-6"><b>End Date * </b><input type='text' class='input_field' value='' name='end_date' id='end_date' >&nbsp <input type='button' id='form_button' value='View Report' onclick='run_report()'></div>
